...
export const AssignmentHero: React.FC<AssignmentHeroProps> = ({
  ...
  return (
    <section className="px-4 md:px-8 py-8 md:py-10 bg-transparent relative">
      <div 
        className="max-w-[1200px] mx-auto rounded-lg border overflow-hidden relative p-8 md:p-12 text-left"
        style={{ 
      ...
      >
        <div className="absolute top-0 right-0 w-[300px] h-[300px] rounded-full blur-[100px] pointer-events-none" style={{ backgroundColor: "rgba(255, 255, 255, 0.2)" }} />
        <div className="absolute -bottom-10 left-10 w-[200px] h-[200px] rounded-full blur-[80px] pointer-events-none" style={{ backgroundColor: "rgba(20, 27, 44, 0.2)" }} />
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-4 flex justify-start lg:justify-end">
            <div 
              className="px-6 py-4 rounded-lg border backdrop-blur-md flex flex-col gap-1 w-full max-w-[260px] text-left"
              style={{ backgroundColor: "rgba(255,255,255,0.1)", borderColor: "rgba(255,255,255,0.15)" }}
            >
              <span className="text-[10px] uppercase font-bold tracking-wider opacity-75 text-white">Instant Access</span>
              <span className="text-lg font-black text-white" style={{ color: "var(--main-black, #141B2C)" }}>100% Solved PDF</span>
              <span className="text-[11px] opacity-90 font-medium text-white">Prepared by IGNOU Experts</span>
            </div>
          </div>
        </div>
      </div>
